...
type PicesClass = "peon" | "caballo" | "alfil" | "rey" | "reina" | "torre";
...
[
  ...
  { ficha: "peon", initialPlace: "e7", idPiece: "4eNv0f26" },
  { ficha: "peon", initialPlace: "f7", idPiece: "e7jH56Nh" },
  { ficha: "peon", initialPlace: "g7", idPiece: "oxlOxvTP" },
  { ficha: "peon", initialPlace: "h7", idPiece: "pLdhQtvS" },
...
[
  { ficha: "peon", initialPlace: "a2", idPiece: "7frqtHGA" },
  { ficha: "peon", initialPlace: "b2", idPiece: "4XXkdK6y" },
  { ficha: "peon", initialPlace: "c2", idPiece: "DUPCkshs" },
  { ficha: "peon", initialPlace: "d2", idPiece: "8hxS60KK" },
  ...
  // { ficha: "rey", initialPlace: "d8", idPiece: "Y1ewJ8J6" },
  // { ficha: "reina", initialPlace: "e8", idPiece: "cw63CfYg" },
];

export const peonCanChangeTo: PicesClass[] = ["torre", "caballo", "alfil",  "reina"]
